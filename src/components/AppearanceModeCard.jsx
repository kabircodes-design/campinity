  ...
  return (
    <button
      ...
      className={`relative flex flex-col items-start gap-1 rounded-2xl border-2 px-4 py-3.5 text-left transition-all duration-300 ${
        active
          ? 'border-blue-600 bg-blue-50/60 shadow-md shadow-blue-100 dark:bg-blue-500/15 dark:shadow-none'
          : 'theme-border theme-bg-surface hover:border-gray-300 dark:hover:border-white/20'
      }`}
    >
