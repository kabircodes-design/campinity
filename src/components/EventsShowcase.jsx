...
export default function EventsShowcase() {
  return (
    <section id="events" className="py-20 sm:py-28 theme-bg-surface border-y theme-divider theme-section-glow">
      <Container className="!px-0 sm:!px-8 lg:!px-10">
        ...
        <div className="mt-10 flex gap-4 overflow-x-auto scroll-hidden snap-x snap-mandatory px-5 sm:px-0 pb-2">
          {events.map((event, i) => (
            <motion.article
              ...
              className="snap-start flex-shrink-0 w-[260px] sm:w-[280px] rounded-xl2 border theme-border theme-bg-background overflow-hidden theme-shadow-soft"
            >
              ...
              <div className="p-4">
                <h3 className="font-display font-semibold text-[15px] theme-text-primary">{event.title}</h3>
                <div className="mt-2.5 space-y-1.5">
                  <p className="flex items-center gap-1.5 text-[12.5px] theme-text-secondary">
        ...
        <p className="mt-4 px-5 sm:px-0 font-mono text-2xs theme-text-muted uppercase tracking-[0.1em]">
          Swipe to explore →
        </p>
      </Container>
    </section>
