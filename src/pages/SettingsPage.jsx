  ...
  return (
    <div className="lg:flex lg:h-screen lg:overflow-hidden bg-gray-50">
      ...
      <div className="min-h-screen w-full max-w-[100vw] lg:max-w-none lg:h-screen lg:overflow-y-auto overflow-x-hidden bg-gray-50">
        <div className="mx-auto max-w-[480px] lg:max-w-[640px] bg-white min-h-screen lg:min-h-0 lg:my-6 lg:rounded-2xl lg:shadow-[0_1px_3px_rgba(15,23,42,0.06)] lg:border lg:border-gray-100">
          ...
          <main className="pb-24 lg:pb-8">
            {profile && (
              <section className="mt-3 mx-4 rounded-2xl border border-gray-100 p-4">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">Campus identity</p>
                <p className="text-sm font-bold text-gray-900">{profile.displayName || 'Student'}</p>
            ...
            <p className="mt-6 text-center text-xs text-gray-400">Campinity — Version 1.0.0 (MVP)</p>
          </main>
        </div>
      </div>
